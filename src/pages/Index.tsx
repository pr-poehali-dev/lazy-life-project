          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="bg-[#FDE1D3] border-none shadow-md hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription className="text-[#403E43]">
                  Дайте мозгу отдохнуть и подзарядиться.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm md:text-base">
                  Научные исследования доказывают, что периоды ничегонеделания
                  необходимы для восстановления когнитивных функций.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-[#E5DEFF] border-none shadow-md hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription className="text-[#403E43]">
                  Меньше дел — меньше стресса.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm md:text-base">
                  Правильная лень помогает снизить уровень гормонов стресса и
            ...
            <Card className="bg-[#F2FCE2] border-none shadow-md hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription className="text-[#403E43]">
                  Самые гениальные идеи приходят в моменты безделья.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm md:text-base">
                  Во время ленивого созерцания ваш мозг находит неожиданные
                  решения и генерирует творческие идеи.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <footer className="bg-white py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 pt-6 border-t border-[#F1F1F1] text-center text-[#8A898C]">
            <p>
              © 2025 Ленивый клуб. Все права защищены, но нам слишком лень их
              защищать.
            </p>
          </div>
        </div>
